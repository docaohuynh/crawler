...
public class HowIMetYourMother4 {
	...
	public static void main(String[] args) {
		...
		driver.get("http://toomva.com/how-i-met-your-mother-season-7-1-the-best-man-v.923");
		...
		for(int i=1; i <=24; i++){
			...
			File file = new File("E:\\MyProject\\datadichbaihat\\howimetyourmother\\season7\\tap"+i+".txt");
