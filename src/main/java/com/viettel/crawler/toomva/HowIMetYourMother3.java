...
public class HowIMetYourMother3 {
	...
	public static void main(String[] args) {
		...
		driver.get("http://toomva.com/how-i-met-your-mother-season-6-1-big-days-v.898");
		...
		for(int i=1; i <=24; i++){
			...
			File file = new File("E:\\MyProject\\datadichbaihat\\howimetyourmother\\season6\\tap"+i+".txt");
