...
public class HowIMetYourMother6 {
	...
	public static void main(String[] args) {
		...
		driver.get("http://toomva.com/how-i-met-your-mother-season-9-1-the-locket-v.983");
		...
		for(int i=1; i <=24; i++){
			...
			File file = new File("E:\\MyProject\\datadichbaihat\\howimetyourmother\\season9\\tap"+i+".txt");
