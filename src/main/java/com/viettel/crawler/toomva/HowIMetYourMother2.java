...
public class HowIMetYourMother2 {
	...
	public static void main(String[] args) {
		...
		driver.get("http://toomva.com/how-i-met-your-mother-season-5-1-definitions-v.867");
		...
		for(int i=22; i <=24; i++){
			...
			File file = new File("D:\\Project\\datacrawler\\howimetyourmother\\season5\\tap"+i+".txt");
