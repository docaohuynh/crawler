...
public class HowIMetYourMother {
	...
	public static void main(String[] args) {
		...
		driver.get("http://toomva.com/how-i-met-your-mother-season-4-1-do-i-know-you-v.829");
		...
		for(int i=3; i <=24; i++){
			...
			File file = new File("E:\\MyProject\\datadichbaihat\\howimetyourmother\\season4\\tap"+i+".txt");
