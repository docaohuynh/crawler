...
//		this.tags = gettags(title);
		...
		this.metaDesc = "Học tiếng anh qua phim "+title+", học tiếng anh qua phim Walking dead ";
		this.keyword = "Học tiếng anh qua phim "+title+",phụ đề "+title+","+title+" subtitle, học tiếng anh qua phim Walking dead";
		this.driver = driver;
